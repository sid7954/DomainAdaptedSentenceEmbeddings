...
class TextCNN(object):
    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        self.print_embeddings = tf.placeholder(tf.float32, name="print_embeddings")
        ...
        with tf.device('/cpu:0'):
            with tf.name_scope('embedding'):
                self.word_embedding = tf.Variable(tf.random_uniform([vocab_size, embedding_size], -1.0, 1.0), name="W")
